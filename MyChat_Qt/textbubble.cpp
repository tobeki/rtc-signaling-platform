    ...
    :BubbleFrame(role, parent)
{
    ...
    // 关键：关闭自动填充并设置透明属性，且同时对 viewport 生效
    m_pTextEdit->setAttribute(Qt::WA_TranslucentBackground, true);
    m_pTextEdit->setAttribute(Qt::WA_NoSystemBackground, true);
    m_pTextEdit->setAutoFillBackground(false);      // 禁止QTextEdit自己填充背景
    initStyleSheet();
